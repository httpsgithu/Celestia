...
//  Common index stuff
    typedef PackedRangeSet<AstroCatalog::IndexNumber, AstroObject *> InnerMainIndex;
    typedef MultilevelArrayMap<AstroCatalog::IndexNumber, AstroObject *, InnerMainIndex, 22, 32> MainIndex;
 protected:
    /*
...
template<>
inline AstroObject *AstroObject::InnerMainIndex::invalidValue() { return nullptr; }

template<>
inline AstroCatalog::IndexNumber AstroObject::InnerMainIndex::getKey(AstroObject * const&o) { return o->getIndex(); }
